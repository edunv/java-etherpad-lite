...
public class EPLiteClientIntegrationTest {
	...
	public void create_and_delete_group() throws Exception {
		...
		mockServer.when(
				HttpRequest.request().withMethod("POST").withPath("/api/1.2.13/deleteGroup").withBody(new StringBody(
						"apikey=a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58&groupID=g.WfM0bl3xSs585VaD")),
				Times.exactly(1))
				.respond(HttpResponse.response().withStatusCode(201)
						.withBody("{\"code\":0,\"message\":\"ok\",\"data\":null}"));
